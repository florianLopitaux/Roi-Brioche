...
final class Ingredient{
    ...
    public static function getParNom($S_nom): Ingredient{
        ...
        $S_requete = 'select * from Ingredient where nom_Ingredient = ?';
        ...
        {
            $S_nom = $A_enregistrement['nom_Ingredient'];
        }

        return new Ingredient($S_nom);
    }

    public static function creerIngredient(): Ingredient{
